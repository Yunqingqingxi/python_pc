...
class Concert:
        ...
        if self.status == 2:
            ...
            if self.driver.title == '订单确认页':
                ...
                self.driver.find_element(By.XPATH,
                                         '//*[@id="dmOrderSubmitBlock_DmOrderSubmitBlock"]/div[2]/div/div[2]/div[2]/div[2]/span').click()
                time.sleep(2)
                self.pay_order()
    ...
    def pay_order(self):
        if self.driver.title == "支付宝付款":
            ...
            self.driver.find_element(By.XPATH, '//*[@id="app"]/div[3]/div/div[1]/div[2]/input').send_keys(
                '支付宝账号')  # 输入支付宝账号
